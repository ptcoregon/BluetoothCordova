...
;(function()
{
	...
	function connect(device)
	{
			...
			function(device)
	    {
	      console.log('Connected to device: ' + device.name);
				showMessage("Connected to " + device.address);
				connectAttempts = 0;
	...
	function getServiceData(device)
	{
		console.log("getServiceData");
			...
			function(services)
			{
				dataService = evothings.ble.getService(device,"00000010-0000-1000-8000-00805f9b34fb")
				dataChar = evothings.ble.getCharacteristic(dataService,"00000100-0000-1000-8000-00805f9b34fb");
				dataReturnChar = evothings.ble.getCharacteristic(dataService,"00000101-0000-1000-8000-00805f9b34fb");
				console.log("readAllServiceData");
	...
	function sendData(device,data)
	{
		...
		evothings.ble.writeCharacteristic(device,dataReturnChar,data,
		function()
		{
	...
	function readData(device){
		...
		function(readData){
			...
			console.log('uint8 characteristic data: ' + data);
